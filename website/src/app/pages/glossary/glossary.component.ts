...
export class GlossaryComponent {
  readonly terms = [
    ...
    { word: 'Slash Command', anchor: 'slash-command', def: 'One of 29 pre-built commands (e.g., /prodara:build, /prodara:explain) that AI agents use to interact with Prodara. Organized into workflow, spec-edit, query, and management categories.' },
